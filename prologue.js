...
Object.assign(window.story, {
  ...
  prologue_after_qte: [
    ...
    _.thought("*Я должен уйти немедленно, но решил в последний раз обернуться...*"),
    ...
    _.thought("*Затем пустота... Она длилась минут десять. Я слышал лишь странный шёпот.*"),
    ...
    _.say("hero", "Обычно мои сны жестокие, но этот... Он намного жёстче обычного."),
    _.say("hero", "Видимо, моё психическое состояние становится всё хуже...."),
    _.thought("*Сегодня 15 февраля, мой первый день в колледже после долгого отдыха от этого позора.*"),
      ...
      ..._.explore([
        {
          ...
          canTake: false,
          failMsg: "Мне его некуда девать, да я всё равно почти не играю в него.",
        },
        {
          x: 85,
          y: 37,
  ...
  prologue_outside: [
    ...
    _.say("hero", "Вот бы какая-нибудь красивая сталкерша за мной наблюдала..."),
    {
      speaker: "unknown",
    ...
    _.say("unknown", "Прости... Ты сказал, что хочешь сталкершу, вот я и решила..."),
